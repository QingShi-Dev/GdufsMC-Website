...
export const RECOMMENDED_MODS: RecommendedMod[] = [
  ...
  },
  {
    ...
    icon: "/icons/help/Xaero图标.png",  // 跟世界地图共用一个 Xaero 图标
    bg: "bg-violet-100",
  },
  {
    name: "投影",
    en: "Litematica",
    desc: "大型或复杂建筑必备，助你轻松建造建筑",
    icon: "/icons/help/投影图标.png",
    bg: "bg-slate-100",
  },
  {
    name: "Tweakeroo",
    ...
    icon: "/icons/help/Tweakeroo图标.png",
    bg: "bg-amber-100",
  },
  {
    name: "钠",
    en: "Sodium",
    desc: "免费的强大的渲染引擎暨优化模组，可大幅提升游戏的画面渲染性能，提高帧率",
    icon: "/icons/help/钠图标.webp",
    bg: "bg-emerald-100",
  },
];
